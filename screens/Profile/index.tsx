...
const Profile = () => {
  ...
  const [selectedPrizedMovie, setSelectedPrizedMovie] = useState(
    ...
    <View style={ProfileStyles.container}>
      ...
      >
        <View style={ProfileStyles.headerContainer}>
          <TouchableOpacity style={ProfileStyles.avatar} activeOpacity={0.5}>
            <Avatar
              size="large"
        ...
        <View style={ProfileStyles.rowContentContainer}>
          <TouchableOpacity style={ProfileStyles.row} activeOpacity={0.5}>
        ...
        <TouchableOpacity style={ProfileStyles.signOut} activeOpacity={0.5}>
